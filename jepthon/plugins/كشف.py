...
async def fetch_info(replied_user, event):
    ...
    rotbat = ".「  مطـور السورس 𓄂𓆃 」." if user_id == 1752994831 or user_id == 393120911 or user_id == 5560953298 else (".「  العضـو 𓅫  」.") 
    rotbat = ".「 مـالك الحساب 𓀫 」." if user_id == (await event.client.get_me()).id and user_id != 1752994831 else rotbat
