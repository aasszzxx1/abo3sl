...
- مثال: .انشاء حساب الرافدين او ابو عسل الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "ابو عسل الاسلامي":
        bankn = "مصرف ابو عسل الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "ابو عسل الاسلامي":
