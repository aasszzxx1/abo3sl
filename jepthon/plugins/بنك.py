...
- مثال: .انشاء حساب الرافدين او كريزون الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "كريزون الاسلامي":
        bankn = "مصرف كريزون الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "كريزون الاسلامي":
