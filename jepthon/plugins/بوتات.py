...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await catevent.edit("**╮•⎚ تحـقق من انـك لم تقـم بحظر البوت @vvvs7cvv1BoT .. ثم اعـد استخدام الامـر ...🤖♥️**")
            return
...
async def jepvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="⌯︙BY : @vvvs7cvv 🎀",parse_mode="html")
  await vois.delete()
...
async def jepvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="⌯︙BY : @vvvs7cvv 🤲🏻☪️",parse_mode="html")
  await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="ثيم$"))
async def jepThe(theme):
  rl = random.randint(2,510)
  url = f"https://t.me/GSSSD/{rl}"
  await theme.client.send_file(theme.chat_id,url,caption="⌯︙THEME BY : @vvvs7cvv 🎊",parse_mode="html")
  await theme.delete()
