#    جميع الحقوق لمطوري سورس ابو عسل حصريا لهم فقط
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/BBXBBT"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب ابو عسل  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/BBXBBT")],
            ],
        )
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("كروب المساعدة ❓", "https://t.me/vvvs7cvvSupport")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @vvvs7cvv", alert=True)
